...
<body>
  <div class="login">
    ...
    <a class="submit" href="<?php echo base_url()."Welcome/regis";?>">Register an Account</a>

    </form>
  </div> <!--/ Login-->

<div class="copyright">
    <p>Copyright &copy; 2017. Created by <a href="http://febbygunawan.com" target="_blank">Prima</a></p>
  </div>
